...
const questionTypes = [
  { value: 'multiple_choice', label: 'Multiple Choice', icon: <CheckCircle className="h-4 w-4" /> },
  { value: 'true_false', label: 'True/False', icon: <XCircle className="h-4 w-4" /> },
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-slate-800 dark:text-white">Quiz Builder</h1>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <Select 
                        ...
                        onValueChange={(value) => setAiSettings(prev => ({ ...prev, lessonId: value }))}
                      >
                        <SelectTrigger>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="lesson-2">Limits and Continuity</SelectItem>
                          <SelectItem value="lesson-3">Derivatives Basics</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                        ...
                        {questionTypes.map((type) => (
                          <div key={type.value} className="flex items-center space-x-2">
                            <input
                              type="checkbox"
                              id={type.value}
                              checked={aiSettings.questionTypes.includes(type.value)}
                              onChange={(e) => {
                                if (e.target.checked) {
                                  setAiSettings(prev => ({
                                    ...prev,
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">{statisticsData?.totalQuizzes || 0}</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">{statisticsData?.publishedQuizzes || 0}</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">{statisticsData?.averageScore || 0}%</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">{statisticsData?.completionRate || 0}%</p>
                </div>
              ...
              <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => setCurrentQuiz(prev => ({ ...prev, timeLimit: parseInt(e.target.value) }))}
                          placeholder="30"
                        />
                      </div>
                      <div>
                ...
                <Card className="border-white/30 bg-white/80 backdrop-blur-xl shadow-xl">
                  <CardHeader className="flex flex-row items-center justify-between">
                    <CardTitle>Questions ({currentQuiz.questions?.length || 0})</CardTitle>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) => setCurrentQuiz(prev => ({ ...prev, allowMultipleAttempts: checked }))}
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) => setCurrentQuiz(prev => ({ ...prev, shuffleQuestions: checked }))}
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) => setCurrentQuiz(prev => ({ ...prev, shuffleOptions: checked }))}
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) => setCurrentQuiz(prev => ({ ...prev, showCorrectAnswers: checked }))}
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) => setCurrentQuiz(prev => ({ ...prev, showScoreImmediately: checked }))}
                      />
                    </div>
                  </CardContent>
                </Card>
          ...
          <TabsContent value="analytics">
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
              <Card className="border-white/30 bg-white/80 backdrop-blur-xl shadow-xl">
                ...
                <CardContent>
                  <div className="space-y-4">
                    {statisticsData?.topPerformingQuizzes?.map((quiz, index) => (
                      <div key={quiz.id} className="flex items-center space-x-4 p-3 rounded-lg bg-muted/30">
              ...
              <Card className="border-white/30 bg-white/80 backdrop-blur-xl shadow-xl">
                ...
                <CardContent>
                  <div className="space-y-4">
                    {statisticsData?.questionTypeDistribution?.map((type, index) => (
                      <div key={index} className="space-y-2">
                        ...
                        <p className="text-xs text-muted-foreground">{type.count} questions</p>
                      </div>
