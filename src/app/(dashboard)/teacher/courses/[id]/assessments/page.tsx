...
export default function AssessmentsPage() {
  ...
  const handleCreateNew = () => {
    router.push(`/teacher/courses/${courseId}/assessments/create`);
  };

  const handleEdit = (id: string) => {
    router.push(`/teacher/courses/${courseId}/assessments/${id}/edit`);
  };

  const handleDuplicate = async (id: string) => {
    try {
      const result = await duplicateAssessment(id).unwrap();
      router.push(`/teacher/courses/${courseId}/assessments/${result.id}/edit`);
    } catch (error) {
