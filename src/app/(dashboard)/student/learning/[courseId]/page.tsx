...
export default function LearningPage() {
  ...
  useEffect(() => {
    if (courseId && currentLessonId && !isLearningStarted) {
      handleStartSession();
    }
  }, [courseId, currentLessonId, isLearningStarted]);
  ...
  const handleLessonChange = (lessonId: string) => {
    ...
    window.history.replaceState(null, '', `/learning/${courseId}?lesson=${lessonId}`);
  };
